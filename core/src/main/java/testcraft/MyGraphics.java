...
//COPY-PASTED FROM LibGdxGraphics


public class MyGraphics implements Graphics {
    private static final String LOGGING_TAG = MyGraphics.class.getSimpleName();
    ...
    public MyGraphics(GameWrapper gameWrapper, SpriteBatch spriteBatch, PolygonSpriteBatch polygonSpriteBatch, ShapeRenderer shapeRenderer) {
        super();
    ...
    public void drawParticleEffect(ParticleEffect effect) {
        ...
        System.out.println("[MyGraphics drawParticleEffect nie dziala, mozna to zmienic uzywajac refleksji"); //dodam to kiedys
    }
    ...
    public void drawNinePatch(NinePatch ninePatch, float x, float y, float width, float height) {
      ...
      //  ninePatch.draw(spriteBatch, x, y, width, height);
        System.out.println("[MyGraphics] drawNinePatch nie dziala, mozna to zmienic uzywajac refleksji"); //dodam to kiedys
    }
    ...
    public String toString() {
        return "MyGraphics [color=" + color + ", backgroundColor=" + backgroundColor + ", tint=" + tint
