...
public class    MenuScreen extends BasicGameScreen {
    ...
    private Stage stage;
    private static boolean newGameButton=false;
    private static boolean quitButton=false;
    private static boolean setstage=true;
    ...
    public void initialise(GameContainer gc) {
        ...
        System.out.println(stage.getCamera().projection);
